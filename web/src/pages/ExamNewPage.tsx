        ...
        <div className="form-grid" style={{ maxWidth: 720, marginTop: "1rem" }}>
          ...
          {isSimulado ? (
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              {simQuery.isError ? (
                <p className="error" role="alert">
                  {simQuery.error instanceof ApiError ? simQuery.error.message : "Erro"}
                </p>
              ) : null}
              {axisBlocks.length > 0 ? (
                <ul className="list">
              ...
              {suggestionsQuery.data ? (
                <div className="table-wrap">
                  <p className="small muted">
                    Serão usados até 8 descritores mais fracos, 2 questões cada (ajuste futuro na API se precisar). A prova é
                    registrada como diagnóstico inicial.
                  </p>
