/** Ícones stroke minimalistas (estilo Vercel/Bolt), sem dependência extra. */
const stroke = {
  width: 18,
  height: 18,
  viewBox: "0 0 24 24",
...
export function NavIcon({ to }: { to: string }) {
  ...
  switch (to) {
    ...
    case "/provas":
      return (
        <svg className={cn} {...stroke} aria-hidden>
          <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9h2m-2 4h2" />
        </svg>
      );
    case "/questoes":
      return (
    ...
    case "/municipio":
      return (
        <svg className={cn} {...stroke} aria-hidden>
          <path d="M9 20l-5.447-2.724A1 1 0 0 1 3 16.382V5.618a1 1 0 0 1 .553-.894L9 2l6 3 5.447-2.724A1 1 0 0 1 21 5.618v10.764a1 1 0 0 1-.553.894L15 20l-6-3-6 3z" />
        </svg>
      );
    case "/escola/resumo":
      return (
